...
void setupData() {
  float vertices[] = {
      0.0f,  -0.7f, 1.0f, 0.0f, 1.0f, // u0
      0.5f,  -0.8f, 0.3f, 0.4f, 0.5f, // u1
      0.6f,  0.0f,  0.5f, 0.1f, 0.9f, // u2
      0.4f,  0.8f,  0.2f, 0.4f, 0.8f, // u3
      -0.4f, 0.8f,  0.2f, 0.8f, 0.2f, // u4
      -0.6f, 0.0f,  0.5f, 0.9f, 0.3f, // u5
      -0.5f, -0.8f, 0.5f, 0.9f, 0.5f, // u6
  };

  unsigned int indices[] = {
      0, 1, 2, 3, 4, 5, 6, // triangle fan

      0, 5, 6, 0, 5, 4, 0, 3, 4, 0, 3, 2, 0, 1, 2, // triangle strip
  };
...
int main(void) {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    case 1:
      ...
      glVertexAttrib3f(v_colorLoc, 1.0f, 1.0f, 1.0f);
      glDrawElements(GL_TRIANGLE_STRIP, 15, GL_UNSIGNED_INT,
                     (void *)(7 * sizeof(unsigned int)));
      glEnableVertexAttribArray(v_colorLoc);
      break;
    }
