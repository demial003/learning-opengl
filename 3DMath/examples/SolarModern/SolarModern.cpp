...
//double viewAzimuth = 0.0;	// Angle of view : solar system is viewed from the side
...
void key_callback(GLFWwindow* window, int key, int scancode, int action, int mods) {
    ...
    case GLFW_KEY_A:
        if (viewAzimuth == 0.25) {
            ...
            viewAzimuth = 0.25;         // View from an angle of 0.25 radians above the orbital plane
        }
...
int main() {
    ...
    printf("Press 'a' or 'A' (Azimuth angle) to change between three view angles.\n");
